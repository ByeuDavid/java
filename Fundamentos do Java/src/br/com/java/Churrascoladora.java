 ...
 * @author Gabriel David, Sabrina da Silva
 */
...
public class Churrascoladora {
	...
	public static void main(String[] args) {
		// Variáveis
		double homens, mulheres, criancas, carne, cerveja, refri, total, valorPessoa,
				totalCarne, totalCerveja, totalRefri;
		...
		System.out.println("Quantidade total de cerveja: " + totalCerveja + " latas" + " | "+ "R$: " + totalCerveja * cerveja);
